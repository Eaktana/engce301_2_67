...
const config = {
  databaseURI: 'mongodb://wallboarduser:WB1qazxsw2@192.168.198.4:27017/wallboarddb',
  ...
  serverURL: 'https://172.26.183.89:' + apiport + '/api', // Don't forget to change to https if needed
  publicServerURL: 'https://172.26.183.89:' + apiport + '/api',
  liveQuery: {
